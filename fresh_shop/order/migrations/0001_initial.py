# Generated by Django 2.1.5 on 2019-01-14 03:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_CLOSE', '交易关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_SUCCESS', '成功'), ('TRADE_FINISHED', '交易结束'), ('paying', '待支付')], default='paying', max_length=20, verbose_name='交易状态')),
